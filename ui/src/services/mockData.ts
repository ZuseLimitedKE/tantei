...
export const mockAgents: AgentData[] = [
  ...
  },
  {
    ...
    description:
      "Capitalizes on medium-term price movements in HBAR using technical analysis and market sentiment indicators.",
  ...
  },
  {
    ...
    avatarUrl:
      "https://images.unsplash.com/photo-1614853735426-4be54638d1dd?q=80&w=128&auto=format&fit=crop",
    description:
      "High-frequency trading bot that exploits small price gaps in HBAR and other Hedera-based assets for quick profits.",
  ...
  },
  {
    ...
    avatarUrl:
      "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=128&auto=format&fit=crop",
    description:
      "Uses advanced trend detection algorithms to identify and follow established market trends across the Hedera ecosystem.",
  ...
  },
  {
    ...
    avatarUrl:
      "https://images.unsplash.com/photo-1621501103258-3e132c689a49?q=80&w=128&auto=format&fit=crop",
    description:
      "Risk-managed strategy that maintains exposure to HBAR while hedging against downside with algorithmic position management.",
  ...
  },
  {
    ...
    avatarUrl:
      "https://images.unsplash.com/photo-1607893378714-007fd47c8719?q=80&w=128&auto=format&fit=crop",
    description:
      "Smart dollar-cost averaging strategy that optimizes buy-ins based on volatility indicators and market conditions.",
