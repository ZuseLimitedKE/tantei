...
const AgentCard = ({ agent, compact = false }: AgentCardProps) => {
  ...
  return (
    <Card className={cn("overflow-hidden card-hover", compact ? "h-full" : "")}>
      <CardContent className={cn("p-5", compact ? "pb-2" : "")}>
        ...
        <div
          className={cn("grid gap-4", compact ? "grid-cols-2" : "grid-cols-3")}
        >
      ...
      >
        ...
        {/*TODO: NAVIGATE TO THE AGENT VIEW PAGE*/}
