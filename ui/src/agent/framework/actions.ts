...
export const CHOOSE_UI_BLOCK_ACTION = Action.define<ParseInputSchema, UIBLOCK[]>({
    ...
    description: "Choose a UI block to display, and determine the props to pass to it, based on the result of the task. There can be multiple UI blocks, chosen especially if the user asks to copy an agent's trades.",
