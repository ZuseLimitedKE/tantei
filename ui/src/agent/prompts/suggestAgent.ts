...
tradingPrompt.input({
    ...
    Your tools include: 
    **getAgentDetailsFromDB** - Use this tool to get all available agents in the network, and their details. Useful in answering user questions.
    `,
    tools: [
        {
            name: "getAgentDetailsFromDB",
            description: "Use this tool to answer a specific question about the agents in the network, or recommend an agent based on user query",
