...
import { mockAgents, generateMockTradeHistory, generatePerformanceData } from '@/services/mockData'
...
import { ChevronLeft, Star, TrendingUp, BarChart3, Users, Clock, AlertCircle, Wallet } from 'lucide-react'
...
function AgentDetailComponent() {
  ...
  const tradeHistory = generateMockTradeHistory(agent.id)
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container px-4 py-8 mx-auto">
        <div className="max-w-screen-xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{agent.strategyType}</p>
                </div>
              </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${agent.roi >= 0 ? 'text-green-500' : 'text-red-500'}`}>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">{agent.riskScore}/10</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
          ...
          {/* Performance Chart */}
          <div className="mb-8">
            <PerformanceChart data={performanceData} title="Performance History" />
          </div>
          ...
          <div className="text-center my-10">
            <h2 className="text-2xl font-bold mb-4">Ready to start copying this agent?</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
              Connect your wallet and set up automated trading with {agent.name}. You'll be able to customize risk levels and maximum exposure.
            </p>
            <Button size="lg" className="px-8">Start Copying Trades</Button>
          </div>
        </div>
      </main>
    </div>
